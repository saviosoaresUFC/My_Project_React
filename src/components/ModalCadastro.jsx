    ...
    return (
        <>
                ...
                <Modal.Body>
                    ...
                    >
                        ...
                        <Form.Group className='w-100 d-flex justify-content-evenly' controlId="buttons">
                            <Button className='btn-cancelar' variant='secondary' onClick={() => {
                                setToastShow(true)
                                props.onHide()
                            }
                            }>Cancelar</Button>
                            <Button className='btn-registrar' variant="primary" type='submit'>Registrar-se</Button>
                        </Form.Group>
                    </Form>
                </Modal.Body>
            </Modal >
            <ToastExample
                ...
                bg='secondary'
                title='Cancelamento'
                text='Tentativa de cadastro cancelada!'
            />
        </>
    )
}
